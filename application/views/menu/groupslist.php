...
?>
<tr>
    <td><?php echo form::checkbox('groups[]', $group->id) ?></td>
    <td class="name">
        <?php
            echo $group->name;
        ?>
        <div>
            <?php
                 echo html::anchor('admin/kohana/menus/edit/'.$group->id, 'Edytuj');
                 echo html::anchor('admin/kohana/menus/remove'.$group->id, 'Usuń', array('class' => 'delete'));
             ?>
        </div>
    </td>
    <td><?php
